...
def register_tool(mcp: FastMCP):
    ...
    def crop(
        ...
        y_start: Annotated[int, Field(description="Starting y-coordinate (row) for the crop region (top)")],
        y_end: Annotated[int, Field(description="Ending y-coordinate (row) for the crop region (bottom)")],
        x_start: Annotated[int, Field(description="Starting x-coordinate (column) for the crop region (left)")],
        x_end: Annotated[int, Field(description="Ending x-coordinate (column) for the crop region (right)")],
